...
<div class="header" >
	...
	<center>	<h2 style="font-family:Caladea;color:#9933ff;text-align:center;">Our Services</h2>
	<div class="btn1">
	<table border="0" cellspacing="20px">
		<tr>
			<td align="center"><a href="intel.php"><img src="fir-44-484307.png" width="177" height="177" vspace="20" /></a></td>
			<td align="center"><a href="status.php"><img src="kindpng_1756768.png" width="177" height="177" vspace="20" /></a></td>
			<td align="center"><a href="ir.php"><img src="report.png" width="177" height="177" vspace="20" /></a></td>
			<td align="center"><a href="cancel.php"><img src="oie_gvtpULjeXbuL.png" width="177" height="177" vspace="20" /></a></td>
		</tr>	
		<tr>
			<td align="center"><button class="button" onclick="location.href='intel.php'"><span>Register complaint </span></button></td>
			<td align="center"><button class="button" onclick="location.href='status.php'"><span>Complaint Status </span></button></td>
			<td align="center"><button class="button" onclick="location.href='ir.php'"><span>Investigation report </span></button></td>
			<td align="center"><button class="button" onclick="location.href='cancel.php'"><span>Cancel complaint</span></button></td>
		</tr>
	</table>
	</div>
</body>
