...
//seraching in database
	$q1=mysqli_query("select * from complaint where complaintid ='$emailid'");
	$result=mysqli_query($con,$q1);
	if($result)		
	{
		echo '<script>';
		echo 'alert("Click here to download the report !!!")';  
		echo '</script>';
...
<head>
<script type="text/javascript" src="irvalidate.js">
</script>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<title>Investigation Report</title>	<link rel="stylesheet" type="text/css" href="header.css" /> 
...
<div class="header" >
	...
	<div class="login">	<h2 style="font-family:Caladea;color:#9933ff;text-align:center;">INVESTIGATION REPORT</h2>
		<div class="log">
			  <img src="report.png"  class="image" width="600"  height="400" />		
		</div>
		<div class="login-right">
			...
			<h3 style "font-weight:bold">Complaint ID:</h3><i class="fa fa-file icon"><input type="text" placeholder="Enter Complaint ID" name="firno"/></i>
           			<br/>
			<button type="submit" value="Submit">Download report</button>
