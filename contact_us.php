...
<div class="header" >
	...
	<div class="login"><br>
	<div class="log">
		  	<img src="contact-us-logo-png-5.png"  class="image" width="600"  height="400" />		</div>
	  ...
	  <div class="login-right">
		  <table border="0">
		  <tr>
		  	<th><h1 style="padding-right:120px">Email us at:</h1></th>
			<th><h1 style="padding-right:120px">Call us at:</h1></th>
		  </tr>
		  <tr>
		  	<td><h3 style=" color:#FF6600; font-size:20px; font-family:Modern" align="left" style="padding-left:50px">info.illicitgoods@gmail.com</h3></td>
			<td><h3 style=" color:#FF6600; font-size:20px; font-family:Modern" align="left" style="padding-left:50px">1800 xxxx xxxx</h3></td>
      </div>
</body>
</html>
